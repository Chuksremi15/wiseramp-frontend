 ...
 * @returns Bank details or undefined if not found
 */
export function getBankByName(bankName: string): BankData | undefined {
 ...
 * @returns Bank details or undefined if not found
 */
export function getBankByCode(bankCode: string): BankData | undefined {
  return NIGERIAN_BANKS.find((bank) => bank.code === bankCode);
}

/**
 * Get bank details by bank slug
 * @param bankSlug - The bank slug to search for
 * @returns Bank details or undefined if not found
 */
export function getBankBySlug(bankSlug: string): BankData | undefined {
  return NIGERIAN_BANKS.find((bank) => bank.slug === bankSlug);
}

/**
 * Search banks by partial name match (case-insensitive)
 * @param searchTerm - The search term to match against bank names
 * @returns Array of matching banks
 */
export function searchBanksByName(searchTerm: string): BankData[] {
 ...
 * @returns Array of all bank data
 */
